...
from evaluation import policy_evaluation_mo
from model_based.probabilistic_ensemble import (
    ProbabilisticEnsemble,
)
from model_based.utils import ModelEnv, visualize_eval
from morl_algorithm import MOAgent, MOPolicy
from networks import NatureCNN, mlp
...
from linear_support.linear_support import LinearSupport
    ...
    def train_iteration(
        ...
        for _ in range(1, total_timesteps + 1):
            ...
            if eval_env is not None and self.log and self.global_step % eval_freq == 0:
                ...
                print("########Evaluating policy.##########: ", self.global_step)
                for w in get_eval_w(32, self.reward_dim):
                    eval_mo(self, eval_env, w)
                print("########Done.##########")
            ...
            if terminated or truncated:
                ...
                if self.log and "episode" in info.keys():
                    log_episode_info(info["episode"], np.dot, weight, self.global_step, writer=self.writer, verbose=False)
    ...
    def train(
        ...
        for iter in range(1, max_iter + 1):
            ...
            if weight_selection_algo == "ols":
                ...
                print("#######Evaluating weight vector:")
                for w in get_eval_w(32, self.reward_dim):
                    eval_mo(self, eval_env, w)
                print("########Done.##########")

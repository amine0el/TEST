...
from morl_algorithm import MOAgent
...
tags = ["pql","ser","deep-sea-treasure",'dst_pql_ser_test']
class PQL(MOAgent):
    """Pareto Q-learning.
    ...
    def train(
        ...
        while self.global_step < total_timesteps:
            ...
            print(f'Episode: {self.global_step}, Reward: {episode_reward}, Epsilon: {self.epsilon}')
